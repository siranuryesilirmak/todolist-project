...
function createNewElement (toDo) {
    ...
    const todonode = document.createTextNode(toDo) // text oluşturuyoruz sonra bu texti li nin içine append edebiliriz.
    liPend.append(todonode)//todonode: oluşturduğumuz metin. lipend: liste elemntimiz. listenin içine todonode u aldık.
    const buttonNode = document.createElement("button")
    buttonNode.classList.add("close","h-100","p-3")
    const btnSpanNode = document.createElement("span")
    btnSpanNode.innerHTML="&times;" //html entities sembolleri yazmak için böyle isimlendirmeler yapılmış. örneğin  &times: x  &Oslash; Ø
